Includes the script to make the satellite data layers, and the scripts used to test the workflow of the GIS tutorials of Urban Mods, 2019 (https://environment.yale.edu/mods/urban/)
